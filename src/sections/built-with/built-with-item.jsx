...
export function BuiltWithItem({ project }) {
  ...
  const getStatusIcon = () => {
    ...
    if (project.isFeatured) {
      return <Iconify icon="solar:rocket-bold" width={16} sx={{ color: 'warning.main' }} />;
    }
    return null;
  };
    ...
    >
      ...
      <Box sx={{ flex: 1, minWidth: 0 }}>
        ...
        {(project.excerpt || project.description) && (
          ...
          >
            {isExpanded ? project.description : project.excerpt}{' '}
            <Box
              component="span"
              onClick={(e) => {
                e.preventDefault();
      ...
      >
        <Typography
          ...
          sx={{
            fontWeight: 700,
            color: project.replies > 10 ? 'warning.main' : 'text.primary',
      ...
      >
        <Typography
          ...
          sx={{
            fontWeight: 700,
            color: project.views > 1000 ? 'warning.main' : 'text.primary',
            fontSize: '1rem',
          }}
        >
